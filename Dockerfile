...
RUN mkdir $VITASDK
RUN wget -O- 'https://github.com/vitasdk/autobuilds/releases/download/master-linux-v2.535/vitasdk-x86_64-linux-gnu-2025-07-20_13-03-36.tar.bz2' | tar xj -C $VITASDK --strip-components=1
